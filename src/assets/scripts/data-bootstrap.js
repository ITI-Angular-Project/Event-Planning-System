...
let users = JSON.parse(localStorage.getItem('users')) || [
  { id: 1, name: "Admin", email: "admin@eps.com", role: "admin", phone: "0100000000", password: encryptText("Admin123!") },
  { id: 2, name: "Organizer One", email: "organizer1@eps.com", role: "organizer", phone: "0100000001", password: encryptText("Organizer123!") },
];

// ---------- EVENTS ----------
let events = JSON.parse(localStorage.getItem('events')) || Array.from({ length: 5 }, (_, i) => ({
  id: i + 1,
  name: `Event ${i + 1}`,
...
console.log("✅ Event Planning System data loaded successfully (normalized).");
